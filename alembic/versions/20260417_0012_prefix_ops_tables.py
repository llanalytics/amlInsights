"""prefix operational tables and add compatibility views

Revision ID: 20260417_0012
Revises: 20260416_0011
Create Date: 2026-04-17 09:35:00
"""
...
OPS_RENAMES: list[tuple[str, str]] = [
...
def upgrade() -> None:
    ...
    for old_name, new_name in OPS_RENAMES:
