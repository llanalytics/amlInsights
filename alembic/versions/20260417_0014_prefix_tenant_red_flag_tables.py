"""prefix tenant red-flag tables and add compatibility views

Revision ID: 20260417_0014
Revises: 20260417_0013
Create Date: 2026-04-17 10:35:00
"""
...
TENANT_RF_RENAMES: list[tuple[str, str]] = [
...
def upgrade() -> None:
    ...
    for old_name, new_name in TENANT_RF_RENAMES:
